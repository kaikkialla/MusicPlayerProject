...
public class Database {
    ...
    public static final LibSong[] Array = {



            new LibSong(0,"Mario", "Mario Theme", MarioUri, R.drawable.a)
            ,new LibSong(0,"Wii", "Wii theme", WiiUri, R.drawable.b)
            ,new LibSong(0,"Undertale", "Megalovania", UndertaleUri, R.drawable.c)
