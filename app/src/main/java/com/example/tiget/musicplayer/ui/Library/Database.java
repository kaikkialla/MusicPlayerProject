...
public class Database {
    ...
    public static final Song[] Array = {



            new Song(0,"Mario", "Mario Theme", MarioUri, R.drawable.a)
            ,new Song(0,"Wii", "Wii theme", WiiUri, R.drawable.b)
            ,new Song(0,"Undertale", "Megalovania", UndertaleUri, R.drawable.c)
